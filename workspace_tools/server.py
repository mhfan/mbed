...
def run_host_test(client, name, disk, port, duration, extra_serial, is_stlink):
    print "{%s}"  % name,
...
class Tester(BaseRequestHandler):
    ...
    def handle(self):
        ...
        result = run_host_test(self.request, test.host_test, disk, port, duration, extra_serial, is_stlink)
